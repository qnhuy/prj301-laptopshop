 ...
 * @author NCPC
 */
@WebServlet(name = "CreateUser", urlPatterns = {"/admin/user/create"})
...
public class CreateUser extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        User userNew = new User(email, password, firstName, lastName, address, phone, finalAvatar1, roleId);
        UserDAO userDAO = new UserDAO();
        userDAO.addNewUser(userNew);
